...
system_stat_current(){
    ...
    DATA_STRING="'${TIMESTAMP}','${CPU}','${LOAD_1}','${LOAD_1}','${LOAD_15}','${DISK_USAGE}','${DISK_TOTAL}','${MEM_USAGE}','${MEM_TOTAL}','${NET_RECEIVED}','${NET_TRANSMITTED}','${NET_TOTAL}'"
    echo ${DATA_STRING}
}
...
show_legends(){
    ...
    echo "  ----------------------------------------------------------------------------------------"
    echo "  *                                                                                       "
    echo "  *   Server B Dashboard        : http://${public_ip}:${server_b_port}/app/dashboard.php  "
