                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-3 m-auto text-center">
                                <a class="command-btn" command="shutdown" href="javascript:;"><i class="fas fa-stop fa-2x text-danger"></i><br>Stop</a>
                            </div>
                            <div class="col-3 m-auto text-center">
                                <a class="command-btn" command="reboot" href="javascript:;"><i class="fas fa-sync fa-2x text-info"></i><br>Restart</a>
                            </div>
                        </div>
                    </div>
                </div>
