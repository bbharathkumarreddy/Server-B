...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12 col-md-12 mb-12">
            <iframe style="width:100%;height:1000px;" src="<?php echo 'https://'.$public_server_b_access.':'.$server_b_port.'/app/embed-filemanager.php'; ?>"></iframe>
        </div>
        <div class="col-xl-12 col-md-12 mb-12">
            <iframe style="width:100%;height:600px;" src="<?php echo 'https://'.$public_server_b_access.':'.$shell_in_box_access_port; ?>"></iframe>
        </div>
