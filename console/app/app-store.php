            ...
            <div class="card shadow mb-12" id="services">
                ...
                <div class="card-body row ma">
                    ...
                    $list =  array(
                        ...
                        "elasticsearch" => array("name" => "elasticsearch", "img" => "elasticsearch.png", "width" => "29", "css" => "app-card-success", "status" => true),
                        "redis" => array("name" => "redis", "img" => "redis.png", "width" => "38", "css" => "app-card-success", "status" => true),
