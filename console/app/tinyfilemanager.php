        ...
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                if($online_viewer == 'google') {
                    echo '<iframe src="http://' . $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'].fm_enc('?p='.urlencode(FM_PATH).'&vl='.urlencode($file).'') . '" frameborder="no" style="width:100%;min-height:460px"></iframe>';
